...
const run = async (opts) => {
    ...
    await (0, utils_1.parallel)(pages, async (page) => {
        ...
        const contentPath = (0, utils_1.format)(opts.contentPath, { title: frontmatter.title.toLowerCase() }, (val) => (0, utils_1.safeName)(val));
        // // save markdown to disk
        await fs_1.default.promises.mkdir(path_1.default.dirname(contentPath), { recursive: true });
        await fs_1.default.promises.writeFile(contentPath, file, "utf8");
